...
class forwardMessage(forms.ModelForm):
    ...
    class Meta:
        model = TeamLeadersLetterMessages
...
class editProjects(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['assignedToLE'].inital = [(x.pk, x.firstName +"--"+ x.middleName + '-->Lead Engineer-'+ 'for team' +x.team.team) for x in User.objects.filter(directorate=directorate, title='Lead Engineer')]
    class Meta:
        model = Projects
        fields = ['assignedToLE']
...
class forwardOutLetter(forms.ModelForm):
    ...
    class Meta:
        model = TeamLeadersLetterMessagesOut
        exclude = ['dateSent','author']
...
class forwardOutMemo(forms.ModelForm):
    ...
    class Meta:
        model = TeamLeadersMemoMessagesOut
        exclude = ['dateSent','author']